      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full w-full">
          ...
          <div className="px-6 py-6 pb-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
            ...
            {/* Quizzes Section */}
            <h4 className="flex items-center text-gray-900 dark:text-white font-bold text-lg mb-4">
              <span className="w-8 h-8 rounded-lg bg-purple-100 dark:bg-purple-900/50 text-purple-600 dark:text-purple-400 flex items-center justify-center mr-3">
                <svg
                  className="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
            ...
            <div className="space-y-3">
              {student.quizzes.length > 0 ? (
                student.quizzes.map((quiz: any) => (
                  <div
                    key={quiz.quiz_id}
                    className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700/50 hover:border-purple-200 dark:hover:border-purple-800 transition-colors"
                  >
                    <div className="flex-1 min-w-0 pr-4">
                      <p className="text-sm font-medium text-gray-900 dark:text-white truncate">
                        {quiz.title}
