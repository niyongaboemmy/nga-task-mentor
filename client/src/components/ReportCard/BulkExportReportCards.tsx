...
function StatusBadge({ status, error }: { status: ExportStatus; error?: string }) {
  switch (status) {
    case "pending":
      return (
        <span className="flex items-center gap-1.5 text-xs text-orange-600 dark:text-orange-400 font-semibold">
    ...
    case "error":
      return (
        <span
          className="flex items-center gap-1.5 text-xs text-orange-500 font-semibold"
          title={error}
        >
                ...
                {errorCount > 0 && !isExporting && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold
                      border border-orange-200 text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20
                      transition-colors"
                  >
                ...
                {rows.map((row, i) => (
                  <tr
                    ...
                    className={`border-b border-gray-50 dark:border-gray-800/50 transition-colors
                      ${row.status === "done" ? "bg-blue-50/50 dark:bg-blue-900/5" : ""}
                      ${row.status === "error" ? "bg-orange-50/50 dark:bg-orange-900/5" : ""}
