...
interface QuizProctoringAnalyticsPageProps {}

export const QuizProctoringAnalyticsPage: React.FC<
  QuizProctoringAnalyticsPageProps
> = () => {
            ...
            <div className="bg-white/80 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl border border-gray-200/80 dark:border-gray-800/50 card-hover p-4">
              <div className="flex flex-row items-center gap-4">
                <Button
                  onClick={() => navigate(`/quizzes/${quizId}`)}
                  variant="secondary"
                  className="btn-facebook bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-xl focus-ring shadow-lg hover:shadow-xl transition-all duration-200"
                >
                ...
                <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center animate-float">
...
export default QuizProctoringAnalyticsPage;
