    ...
    <div className="space-y-4 animate-fadeIn">
      <div className="max-w-2xl mx-auto">
        <div className="space-y-4">
              ...
              <input
                ...
                className={`w-full px-4 sm:px-6 py-4 sm:py-5 text-xl sm:text-2xl font-bold border-2 rounded-2xl focus:outline-none focus:ring-4 transition-all duration-300 transform bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm ${
                  disabled
                    ...
                    : showCorrectAnswer
                      ? isWithinTolerance
                        ? "border-green-500 bg-green-50/30 dark:bg-green-900/10 focus:border-green-600 focus:ring-green-200 shadow-md"
                        : "border-red-500 bg-red-50/30 dark:bg-red-900/10 focus:border-red-600 focus:ring-red-200 shadow-md"
                      : numericAnswer
                        ? "border-blue-500 bg-blue-50/30 dark:bg-blue-900/10 focus:border-blue-600 focus:ring-blue-200 dark:focus:ring-blue-900 shadow-md"
                        : "border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-200 hover:border-blue-400 dark:hover:border-blue-500"
                } ${numericAnswer ? "scale-[1.01]" : ""}`}
              />
          ...
          {/* Answer feedback */}
          {showCorrectAnswer && (
            <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 border-2 border-blue-200 dark:border-blue-800 rounded-2xl shadow-sm animate-slideInLeft relative overflow-hidden">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-2xl sm:text-3xl font-bold text-blue-900 dark:text-blue-100">
                    {correctAnswer}
                    {questionData.units && (
                      <span className="ml-2 text-lg sm:text-xl font-medium text-blue-700 dark:text-blue-400">
                        {questionData.units}
                      </span>
                    )}
                  </div>
                  {tolerance > 0 && (
                    <div className="text-sm text-blue-700 dark:text-blue-400 mt-2 font-medium">
                      Tolerance: ±{tolerance}
                    </div>
                  )}
                </div>
          ...
          {questionData.acceptable_range && (
            <div className="p-4 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 border-l-4 border-amber-400 dark:border-amber-600 rounded-r-xl shadow-sm animate-slideInRight">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm sm:text-base text-amber-900 dark:text-amber-300">
      ...
      {timeRemaining !== undefined &&
        timeRemaining <= 30 &&
        timeRemaining > 0 && (
          <div className="mt-4 p-3 sm:p-4 bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-900/20 dark:to-amber-900/20 border-l-4 border-yellow-500 dark:border-yellow-600 rounded-r-lg shadow-sm animate-pulse">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-yellow-900 dark:text-yellow-200 font-semibold text-sm sm:text-base">
