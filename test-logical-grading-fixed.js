// Test script with FIXED logical expression grading functions
...
function safeEvalBoolean(expr, env) {
  ...
  console.log("Converted to JS:", js); // Debug log
...
console.log("=== Testing Logical Expression Grading (FIXED) ===");
console.log("");
